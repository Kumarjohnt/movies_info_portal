...
class MoviesData(models.Model):
    ...
    directed_by = models.CharField(max_length=250)
    produced_by = models.CharField(max_length=500)
    written_by = models.CharField(max_length=250)
    screenplay_by = models.CharField(max_length=250)
    story_by = models.CharField(max_length=250)
    based_on = models.CharField(max_length=250)
    starring = models.CharField(max_length=500)
    music_by = models.CharField(max_length=250)
    cinematography = models.CharField(max_length=250)
    edited_by = models.CharField(max_length=250)
    animation_by = models.CharField(max_length=250)
    layouts_by = models.CharField(max_length=250)
    color_process = models.CharField(max_length=250)
    production_company = models.CharField(max_length=500)
    distributed_by = models.CharField(max_length=500)
    release_date = models.CharField(max_length=200)
    running_time = models.CharField(max_length=200)
